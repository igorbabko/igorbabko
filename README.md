...
const developer = {
  ...
  interests: ['📈 investing', '📊 trading', '🪙 crypto', '🏦 defi'],
  hobbies: ['👨‍🏫 teaching', '📚 reading', '🏋️ fitness']
}
```
